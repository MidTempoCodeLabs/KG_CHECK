...
public class Result : IResult
{
    ...
    public static Task<IResult> FailAsync(string message = "An error occurred!")
    {
        return Task.FromResult(Fail(message));
    }

    public static Task<IResult> FailAsync(ResultMessageType messageType)
    {
        return Task.FromResult(Fail(GetMessage(messageType), messageType));
    }
    ...
    public static Task<IResult> SuccessAsync(ResultMessageType messageType)
    {
        return Task.FromResult(Success(messageType));
    }

    protected static string GetMessage(ResultMessageType? id)
    {
        ...
        message = id switch
        {
            ResultMessageType.Error => "An error has occurred.",
            _ => message
        };
...
public class Result<T> : Result, IResult<T>
{
    ...
    public new static Task<Result<T>> FailAsync(ResultMessageType messageType)
    {
        return Task.FromResult(Fail(GetMessage(messageType), messageType));
    }
    ...
    public static Task<Result<T>> SuccessAsync(ResultMessageType messageType)
    {
        return Task.FromResult(Success(GetMessage(messageType)));
    }
    ...
    public static Task<Result<T>> SuccessAsync(T data, ResultMessageType messageType)
    {
        return Task.FromResult(Success(data, messageType));
    }
}
