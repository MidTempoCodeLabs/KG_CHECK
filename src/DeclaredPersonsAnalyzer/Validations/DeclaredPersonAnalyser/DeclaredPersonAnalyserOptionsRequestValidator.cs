...
namespace DeclaredPersonsAnalyzer.Validations.DeclaredPersonAnalyser;

public class DeclaredPersonAnalyserOptionsRequestValidator : AbstractValidator<DeclaredPersonAnalyserOptionsRequest>
{
    public DeclaredPersonAnalyserOptionsRequestValidator()
    {
